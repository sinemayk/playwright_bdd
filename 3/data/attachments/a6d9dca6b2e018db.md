...
- Name: e2e/features/saucelogin.feature.spec.js >> US001 Sauce Demo Login Test >> TC02 Gecerli kullanici girisi
- Location: .features-gen/e2e/features/saucelogin.feature.spec.js:14:7

# Error details

```
Error: Missing step: When kullanici adi "error_user" girer
```
